...
class Part {
    ...
    async catalog(show) {
        ...
        location.pathname == '/X/parts/' ? this.a.href = `/products/?${comp}=${encodeURIComponent(abbr)}` : null;
        location.pathname == '/X/products/' ? this.a.onclick = () => Finder?.find([[comp, abbr]]) : null;
        return this;
    }
}
